export default function SubscribeEmailInput({
  ...
  return (
    <div className="rounded-lg border border-white h-14 flex justify-between">
      <input
        id="subscribe-email"
        type="email"
        placeholder={placeholder}
        className="text-[14px] bg-transparent text-white placeholder:text-white w-full pl-[14px] focus:ring-transparent focus:outline-none"
      ></input>
